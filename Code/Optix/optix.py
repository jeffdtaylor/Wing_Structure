...
def line_search_quad(design_point, obj_value, gradient, s, obj_model, settings):
    ...
    for i in range(nadjust):
        ...
        print('vertex = ', (alpha_min_est, obj_value_est))

        print('convex = ', q.convex())
        print('R^2 = ', q.rsq, ' R^2 tol = ', settings.rsq_tol)
        ...
        if (alpha_min_est is None or alpha_min_est < 0 or not q.convex() or
            ...
            print('ind = ', ind)
            print('nsearch = ', settings.nsearch)
        ...
        print('delta = ', delta)
        print('alpha_tol = ', settings.alpha_tol)
